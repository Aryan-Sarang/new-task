...
file_path = r'C:\Users\Admin\Desktop\kachow.txt'
...
# Export to JSON
buy_json_file = 'buy_orders.json'
sell_json_file = 'sell_orders.json'
buy_summary.to_json(buy_json_file, orient='records', indent=2)
sell_summary.to_json(sell_json_file, orient='records', indent=2)

print(f"Buy orders JSON saved to '{buy_json_file}'")
print(f"Sell orders JSON saved to '{sell_json_file}'")

# Display as tables in terminal
print("\nBuy Orders Table:")
print(buy_summary.to_string(index=False))

print("\nSell Orders Table:")
print(sell_summary.to_string(index=False))